...
function displayQuestions(category) {
  ...
  var questions = jsonData[category];
  ...
  function displayQuestion() {
    ...
    questionElement.textContent = 'Question ' + question.id + ': ' + question.question;
    ...
    for (var j = 0; j < question.options.length; j++) {
      ...
      label.textContent = question.options[j];
    ...
    nextButton.addEventListener('click', function () {
      ...
      if (currentQuestionIndex < questions.length) {
        ...
        // Display end of questions message
        var endMessage = document.createElement('p');
        endMessage.textContent = 'End of questions.';
